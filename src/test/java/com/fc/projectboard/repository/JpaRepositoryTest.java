...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newAufsprit", "pw", null, null, null));
    ...
    @EnableJpaAuditing
    @TestConfiguration //test 할때만 등록하기
    public static class TestJpaConfig {
        @Bean
        public AuditorAware<String> auditorAware() {
            return () -> Optional.of("aufsprit");
        }
    }
