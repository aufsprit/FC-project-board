...
class ArticleControllerTest {
    ...
    @Test
    void givenSearchKeyword_whenRequestingSearchingArticlesView_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    public void givenNothing_whenRequestingArticlePage_thenRedirectsToLoginPage() throws Exception {
        ...
        //redirectedUrl == full url 로 해줘야함. 그래서 패턴을 사용.
        then(articleService).shouldHaveNoInteractions();
    }

    @WithMockUser //실제 사용자 정보를 이용할 수 없다.. 는 문제가 생긴다.
    ...
    @WithUserDetails(value = "aufspritTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    //TestSecurityConfig 에서 만든 목계정을 활용.
